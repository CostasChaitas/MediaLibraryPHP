<?php 
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(!isset($error_message)){
            ...
            $mail->Subject = 'A Suggestion from ' . $email;
             ...
             <table>
                 ...
                 <tr>
                     ...
                     <td>
                        <select id="category" name="category">
                            ...
                            <option value="Music"<?php if(isset($category) && $category == "Music"){ echo " selected"; }?>>Musik</option>
                        </select>                      
                    </td>
                 </tr>
                 <tr>
                ...
                <tr>
                 ...
                 <tr style="display:none">
                     ...
                     <td><input type="text" name="address" id="address"></input><p>Please leave this field empty</p></td>
                 </tr>
             </table>
